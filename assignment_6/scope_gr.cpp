...
int main()
{
...

	{
		...
		cout << "PI, RATE, radius, circumference, and radius are active here" << endl << endl;
...
void findArea(float rad, float& answer)
{
	...
	cout << "PI, RATE, findArea, findCircumference, rad, answer are active here" << endl << endl;
...
void findCircumference(float length, float& distance)
{
	...
	cout << "PI, RATE, findArea, findCircumference, length, distance are active here" << endl << endl;
